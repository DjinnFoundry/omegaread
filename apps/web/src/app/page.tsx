  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] flex items-center justify-center px-6">
      <div className="text-center max-w-2xl">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight font-datos">
          Pequeños Fans de la lectura
        </h1>

        <p className="mt-6 text-lg sm:text-xl text-slate-300 leading-relaxed font-datos">
        ...
        >
          <span className="font-datos">Crear cuenta gratis</span>
